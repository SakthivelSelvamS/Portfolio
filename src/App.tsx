              ...
              <div className="profile-info">
                ...
                <div className="contact-info">
                  ...
                  <div className="social-links">
                    <a href="https://github.com/SakthivelSelvamS" target="_blank" rel="noopener noreferrer" className="social-link">
                    ...
                    <a href="https://www.linkedin.com/in/sakthivel-selvam-7a0b1519b/" target="_blank" rel="noopener noreferrer" className="social-link">
                      <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
